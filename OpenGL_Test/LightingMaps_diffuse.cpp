...
//    // ------------------------------------
//    Shader lightingShader("LightingMaps.vert", "LightingMaps.frag");
...
//        test = MatList.find("brass")->second;
//        //material
//        lightingShader.setVec3("material.ambient", test.ambient);
//        lightingShader.setVec3("material.diffuse", test.diffuse);
//        lightingShader.setVec3("material.specular", test.specular);
//        lightingShader.setFloat("material.shininess", test.shininess);
//        //material
//        //lighting   
//
//        /*glm::vec3 lightColor;
...
//        // world transformation
//        model = glm::mat4(1.0f);
//        //tools.Rotate_Transform_Scale_Object(model,tools.Trans_Scale,glm::vec3(0),0, glm::vec3(0.0,1.0,0.0), glm::vec3(2));
