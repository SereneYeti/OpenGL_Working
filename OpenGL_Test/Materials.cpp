...
void PopulateMaterialList() {
    ...
    mat.diffuse = glm::vec3(0.07568, 0.61424, 0.07568);
    mat.specular = glm::vec3(0.633, 0.727811, 0.633);
    mat.shininess = 0.6f;
    MatList.insert(pair<string,Materials>("emerald", mat));
    ...
    mat.shininess = 0.1f;
    MatList.insert(pair<string, Materials>("jade", mat));
    mat.ambient = glm::vec3();
    mat.diffuse = glm::vec3();
    mat.specular = glm::vec3(0);
    mat.shininess = 0.1f;
    MatList.insert(pair<string, Materials>("obsidian", mat));
}
//Material List
...
{    
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //material
        lightingShader.setVec3("material.ambient", 0.24725f, 0.1995f, 00.0745f);
